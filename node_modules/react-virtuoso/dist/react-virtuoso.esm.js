import React, { createContext, useState, useEffect, useRef, useContext, useCallback, forwardRef, useImperativeHandle } from 'react';
  ...
  combineLatest(renderProp$, groupRenderProp$, scrollSeekConfiguration$, computeItemKey$, itemContainer$, groupContainer$, dataKey$).pipe(map(function (_ref7) {
    ...
    return {
      render: function render(item, _ref8) {
        ...
        if (item.type === 'group') {
          return React.createElement(GroupContainer, _extends({
            key: key
          ...
          return React.createElement(ItemContainer, _extends({}, itemProps, {
            key: key
          }), children);
        }
      }
...
React.memo(function () {
  ...
  return React.createElement(React.Fragment, null, renderedItems);
});
...
var VirtuosoFooter = function VirtuosoFooter(_ref3) {
  ...
  return React.createElement(FooterContainer, {
...
var VirtuosoView = function VirtuosoView(_ref5) {
  ...
  }, React.createElement(VirtuosoList, null), footer && React.createElement(VirtuosoFooter, {
    footer: footer,
...
React.memo(function (_ref) {
  ...
  return React.createElement(VirtuosoContext.Provider, {
    value: contextValue
  }, React.createElement(VirtuosoView, {
...
forwardRef(function (props, ref) {
  ...
  return React.createElement(VirtuosoPresentation, {
    contextValue: state,
    style: props.style,
