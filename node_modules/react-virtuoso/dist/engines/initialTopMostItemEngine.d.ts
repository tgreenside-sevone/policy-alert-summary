...
export declare function initialTopMostItemIndexEngine({ initialTopMostItemIndex, scrollToIndex$, scrollTop$, scrollTo$, offsetList$, }: InitialTopMostItemIndexParams): {
